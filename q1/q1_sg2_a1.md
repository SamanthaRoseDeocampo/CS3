...
Main Problem:
The school canteen has a slow and ungorganized ordering system which causes long waiting time and long lines.
...
1. Add a calculator-like system where it can compute the prices.
2. A list/menu of all items available. A system that can mark items whenever they are available or unavailable.
3. Add queue numbers so everyone follows a sequence.
4. Make the stock-list visible for students to preview before they approach the counter.
